...
$tweaks = @(
	...
	"UninstallMediaPlayer", # "UninstallMediaPlayer",
...
Function InstallLukesStuff {
	
	Write-Output "Installing Steam"
	choco install steam -y
	Write-Output "Installing Winrar"
	choco install winrar -y
	Write-Output "Installing Clang"
	...
	Write-Output "Installing iCUE"
	choco install icue -y
	Write-Output "Installing Space Sniffer"
